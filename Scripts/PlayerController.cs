...
namespace FirstSteps
{
    public class PlayerController : ValidatedMonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            At(from:locomotionState, to:dashState, condition: new FuncPredicate(() => dashTimer.IsRunning));
            Any(locomotionState, condition:new FuncPredicate(() => groundChecker.IsGrounded && !jumpTimer.IsRunning && !dashTimer.IsRunning));
